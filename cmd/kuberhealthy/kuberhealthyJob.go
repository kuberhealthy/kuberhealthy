...
// kuberhealthy.
type KuberhealthyJob interface {
	...
	// Run fires off a single check run. Results of the error are stored within the check.
	// Results should show up when CurrentStatus() is invoked.
