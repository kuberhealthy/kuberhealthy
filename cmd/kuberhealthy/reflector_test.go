...
func makeTestStateReflector(fakeWatcher *watch.FakeWatcher) *StateReflector {
	...
	listerWatcher := &testLW{
		...
		ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
			return &khcrds.KuberhealthyStateList{ListMeta: metav1.ListMeta{ResourceVersion: "1"}}, nil
		},
	}

	sr.reflector = cache.NewReflector(listerWatcher, &khcrds.KuberhealthyState{}, sr.store, sr.resyncPeriod)
...
func TestStart(t *testing.T) {
	...
	fw.Add(&khcrds.KuberhealthyState{ObjectMeta: metav1.ObjectMeta{Name: "bar"}})
