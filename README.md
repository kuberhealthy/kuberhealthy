...
`helm template --set prometheus.enabled=true https://raw.githubusercontent.com/Comcast/kuberhealthy/helm/kuberhealthy/master/kuberhealthy-0.1.0.tgz | kubectl apply -f -`
...
`helm template https://raw.githubusercontent.com/Comcast/kuberhealthy/helm/kuberhealthy/master/kuberhealthy-0.1.0.tgz > kubernetes.yaml`
