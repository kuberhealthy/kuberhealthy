...
- `KH_CHECK_REPORT_URL`: Base URL used by checker pods to report results; `/check` is appended automatically. Do not include `/check` in this value. Default `http://kuberhealthy.<namespace>.svc.cluster.local:8080`.
