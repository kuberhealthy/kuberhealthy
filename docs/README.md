...
- [Prometheus Rules](prometheus/prometheusRules.yaml)
- [ServiceMonitor (Prometheus Operator)](prometheus/SERVICEMONITOR.MD)
- [ServiceMonitor Manifest](../deploy/serviceMonitor.yaml)
- [PodMonitor Example](prometheus/podMonitor.yaml)
