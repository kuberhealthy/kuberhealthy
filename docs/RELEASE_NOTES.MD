...
- The shipped Kustomize base and Helm chart now enable leader election by default so the default `replicas: 2` deployment does not race controller scheduling.
